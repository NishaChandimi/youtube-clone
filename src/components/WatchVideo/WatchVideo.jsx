...
const WatchVideo = () => {
  ...
  // const {fetchVideoDetails, videoDetails} = useFunctions();
  useEffect(() => {
  ...
  // console.log(videoDetails.id.videoId);
        ...
        <div className="video-watch-description">
          ...
          <div className="video-details">
            ...
            <div className="video-options">
              ...
              <div className="video-share"><Share className="video-share-icon" />Share</div>
