...
const Header = () => {
    ...
    const {searchVideos} = useFunctions();
    ...
    return (
        <div className="header">
            ...
            <div className="options">
                ...
                <img className="profile-picture" src="https://yt3.ggpht.com/yti/ADpuP3NO6uBJ_ZU9i2EMD20ufBuA5wW6JpzRpMOZXfqyzw=s88-c-k-c0x00ffffff-no-rj" alt="profile-dp" />
            </div>
        </div>
    )
}
